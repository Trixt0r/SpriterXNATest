...
namespace com.brashmonkey.spriter.objects
{
	...
	public abstract class SpriterAbstractObject
	{
		...
		protected internal com.brashmonkey.spriter.objects.SpriterAbstractObject parent;
		...
		public virtual com.brashmonkey.spriter.objects.SpriterAbstractObject getParent()
		{
			return parent;
		}
